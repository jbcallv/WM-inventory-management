...
# output SQL file
sql_file = open("parserGenerateLarge.sql", "r+")
sql_file.writelines("/*File generated by parserGenerateLarge_generate.py in order to fill database with name *_large with millions of entries */\n")
